...
def team():
    ...
    json_data = json.loads(json.dumps(Team.serialize_list(teams)))
...
def showteam(team_name_abbr):
    ...
    # # json_data = dcu.team_info()
    # # flash(json_data)
    teams = Team.query.filter_by(team_name_abbr = team_name_abbr)
    json_data = json.loads(json.dumps(Team.serialize_list(teams)))
...
def login():
    ...
    if form.validate_on_submit():
        admin = Admin.query.filter_by(admin_= form.name.data).first()
